...
Public Class Sellers
    ...
    Private Sub ClearAllRecordsButton_Click(sender As Object, e As EventArgs) Handles ClearAllRecordsButton.Click
        ...
        Try
            ...
            cmd = New SqlCommand("EXEC deleteAllSellerRecords;", conn)
            conn.Open()
            cmd.ExecuteNonQuery()
    ...
    Private Sub SellersGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles SellersGridView.CellContentClick
        ...
        If e.ColumnIndex.Equals(0) Then
            ...
            Try
                ...
                Dim DeletionId = SellersGridView.Rows(e.RowIndex).Cells("SellerID").Value.ToString()

                cmd = New SqlCommand("EXEC deleteSellerRecord @id;", conn)
        ...
        If e.ColumnIndex.Equals(1) Then
            ...
            Try
                ...
                Dim UpdationId = SellersGridView.Rows(e.RowIndex).Cells("SellerID").Value.ToString()

                Dim updateSeller As New UpdateSeller()

                updateSeller.GetUpdationId(UpdationId)
    ...
    Private Sub AddButton_Click(sender As Object, e As EventArgs) Handles AddButton.Click
        ...
        Try
            ...
            cmd = New SqlCommand("EXEC addNewSellerRecord @n, @e, @p", conn)
            ...
            MessageBox.Show("Seller Data Added Successfully", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
            ClearAllTextBoxes()
    ...
    Private Sub SearchBox_TextChanged(sender As Object, e As EventArgs) Handles SearchBox.TextChanged
        ...
        Try
            ...
            cmd = New SqlCommand("EXEC searchSellerByName @n;", conn)
    ...
    Private Sub ResizeGridViewColumns()
        ...
        SellersGridView.Columns("DeleteColumn").Width = 115
        SellersGridView.Columns("UpdateColumn").Width = 115
        SellersGridView.Columns("SellerID").Width = 135
        SellersGridView.Columns("SellerName").Width = 175
    ...
    Private Sub PopulateGridView()
        ...
        Try
            ...
            If dt.Rows.Count = 0 Then
                ...
                SellersGridView.Visible = False

            Else

                NoDataPanel.Visible = False
                SellersGridView.Visible = True
