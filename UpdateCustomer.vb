...
Public Class UpdateCustomer
    ...
    Private Sub PopulateTextBoxes()
        ...
        Try
            ...
            NameBox.Text = dt.Rows(0)("CustomerName").ToString()
            EmailBox.Text = dt.Rows(0)("CustomerEmail").ToString()
            PhoneNumberBox.Text = dt.Rows(0)("CustomerContact").ToString()
    ...
    Private Sub UpdateButton_Click(sender As Object, e As EventArgs) Handles UpdateButton.Click
        ...
        Try
            ...
            cmd = New SqlCommand("EXEC updateCustomer @id, @n, @e, @p;", conn)
            cmd.Parameters.AddWithValue("@id", Me.UpdationId)
